...
import com.vikash.truck.tracking.barcodedetection.BarcodeField;
import com.vikash.truck.tracking.barcodedetection.BarcodeProcessor;
import com.vikash.truck.tracking.barcodedetection.BarcodeResultFragment;
    ...
    workflowModel.detectedBarcode.observe(
        ...
        barcode -> {
          if (barcode != null) {
            ...
            barcodeFieldList.add(new BarcodeField("Truck Details", barcodevalue));
